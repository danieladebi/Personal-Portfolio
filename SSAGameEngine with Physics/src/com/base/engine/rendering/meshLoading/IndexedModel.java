...
public class IndexedModel
{
	...
	public void CalcNormals()
	{
		for(int i = 0; i < m_indices.size(); i += 3)
		{
			...
			Vector3f v1 = m_positions.get(i1).Subtract(m_positions.get(i0));
			Vector3f v2 = m_positions.get(i2).Subtract(m_positions.get(i0));
	...
	public void CalcTangents()
	{
		for(int i = 0; i < m_indices.size(); i += 3)
		{
			...
			Vector3f edge1 = m_positions.get(i1).Subtract(m_positions.get(i0));
			Vector3f edge2 = m_positions.get(i2).Subtract(m_positions.get(i0));
