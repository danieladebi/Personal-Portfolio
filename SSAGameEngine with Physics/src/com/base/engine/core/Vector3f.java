...
public class Vector3f 
{
	...
	public Vector3f Max(Vector3f other) {
		float x_ = m_x > other.GetX() ? m_x : other.GetX();
		float y_ = m_y > other.GetY() ? m_y : other.GetY();
		float z_ = m_z > other.GetZ() ? m_z : other.GetZ();
	...
	public Vector3f Reflect(Vector3f normal) {
		return this.Subtract(normal.Mul(this.Dot(normal)*2));
	}
	...
	{
		return dest.Subtract(this).Mul(lerpFactor).Add(this);
	}
